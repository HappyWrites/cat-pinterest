# Проект выполнен Назаровой Анастасией в качестве тестового задания в компанию Учи.ру на должность стажера Front-end с использованием фреймворка React (Hooks: state, useeffect; Router), HTML, CSS (flex, grid), взаимодействием с API https://thecatapi.com, соблюдением файловой методологии БЭМ
